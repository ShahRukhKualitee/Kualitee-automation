...
WebUI.selectOptionByValue(findTestObject('Object Repository/select_Select Blocker Major Minor'), 'Minor', true)

WebUI.setText(findTestObject('Object Repository/input_description'), 'Katalon demo')

WebUI.click(findTestObject('Object Repository/button_Save'))
String data =  WebUI.getText('toastr-container')
System.out(data);
