...
Windows.sendKeys(findWindowsObject('Object Repository/Document'), Keys.chord(Keys.ENTER, Keys.DELETE))

Windows.getText(findWindowsObject('Object Repository/Document'))
